...
@pytest.mark.asyncio
async def test_get_price_from_premium_book_matches_single_hole_suffix(tmp_path, monkeypatch):
    import skills.erp_price.client as client_module
    ...
    quote = await ERPPriceClient(SingleHolePremiumBrowser(), config).get_price_quote("2705雅黑单孔")
